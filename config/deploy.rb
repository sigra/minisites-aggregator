...
set :application, 'minisites-aggregator'
application = 'minisites-aggregator'
set :repo_url, 'git@github.com:sigra/minisites-aggregator.git'

# Default deploy_to directory is /var/www/my_app
set :deploy_to, '/var/www/minisites-aggregator'
...
task :foreman_init do
  on roles(:all) do
    ...
    within current_path do
      ...
      execute :bundle, "exec foreman export upstart #{foreman_temp} -a #{application} -u root -l /var/www/#{application}/log -d #{current_path}"
    end
